...
from FallenRobot.utils.commands import command
from FallenRobot.utils.lang import language
from FallenRobot.mongo import taggeddb
from button import Tagalert
from FallenRobot.utils.filter_groups import tagallert
...
**Message:**
{message.text} """
        button_s = InlineKeyboardMarkup([[InlineKeyboardButton("📮 ᴠɪᴇᴡ ᴍᴇssᴀɢᴇ", url=tagged_msg_link)]])
        try:
...
If you are tagged/mentioned in a group where ᴢᴇɴ is present
ᴢᴇɴ will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group ᴢᴇɴ will tell you who mentioned you, 
