...
async def lego(event):
    ...
    if event.sender_id != OWNER_ID and not quew:
        await event.reply(
            "`ɢɪᴠᴇ sᴏᴍᴇ ᴛᴇxᴛ ᴛᴏ ᴄʀᴇᴀᴛᴇ ʟᴏɢᴏ ʙᴀʙʏ​ !`\n`Example /logo <ᴅᴇᴠ>`\nᴘᴏᴡᴇʀᴇᴅ ʙʏ » [𝐃𝐄𝐕](t.me/Dev_Arora_0981)"
        )
        return
    ...
    try:
        ...
        await telethn.send_file(
            event.chat_id,
            file=fname,
            caption=f"☟︎︎︎ ʟᴏɢᴏ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ☟︎︎︎\n ☞︎︎︎ [ᴅᴇᴠ ✘ ʀᴏʙᴏᴛ ](https://t.me/Dev_managerbot) ☜︎︎︎\n\n [    sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ       ](https://t.me/We_rfriends) \n\n ☞︎︎︎ [ᴅᴇᴠᴇʟᴏᴘᴇʀ 🌷](t.me/Dev_Arora_0981) ☜︎︎︎",
        )
        await pesan.delete()
        if os.path.exists(fname):
            os.remove(fname)
    except Exception as e:
        await event.reply(f"ғʟᴏᴏᴅᴡᴀɪᴛ ᴇʀʀᴏʀ, ʀᴇᴩᴏʀᴛ ᴛʜɪs ᴀᴛ @We_rFrIeNdS")


__mod_name__ = "Lᴏɢᴏ​"

__help__ = """
[Dev Robot](t.me/Dev_ManagerBot) can create some beautiful and attractive logo for your profile pics.
