...
If you are tagged/mentioned in a group where Zen is present
Zen will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group Zen will tell you who mentioned you, 
